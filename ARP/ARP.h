...
{	// Ethernet Header	
	NETSIM_MACAddress szDestMac;	///< Destination MAC address.	
	NETSIM_MACAddress szSrcMac;		///< Source MAC address.
	...
	NETSIM_MACAddress sz_ar$sha;	///< Hardware address of the sender.	
	NETSIM_IPAddress sz_ar$spa;		///< Protocol address of the sender.	
	NETSIM_MACAddress sz_ar$tha;	///< Hardware address of target (if know) otherwise empty 6 bytes.	
...
{	
	...
	NETSIM_MACAddress szMACAddress;	///< MAC address or Hardware address of the device	
...
int fn_NetSim_Add_IP_MAC_AddressTo_ARP_Table(ARP_TABLE** ,NETSIM_IPAddress , NETSIM_MACAddress , int  );
