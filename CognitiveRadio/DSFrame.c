...
int fn_NetSim_CR_FormDSFrame(NETSIM_ID nDeviceId, NETSIM_ID nInterfaceId,double dTime)
{
	...
	//Add FCH to BS MAC
	nBurstId = fn_NetSim_CR_FillDSFrame(FCH_SIZE,pstruBSMAC->pstruDSBurst,pstruSymbol,1,&nSlotRequire);
	...
	nBurstId = fn_NetSim_CR_FillDSFrame(nSize,pstruBSMAC->pstruDSBurst,pstruSymbol,1,&nSlotRequire);
	fn_NetSim_CR_AddPacketToDSBurst(pstruBSMAC->pstruDSBurst[nBurstId],pstruPacket);
