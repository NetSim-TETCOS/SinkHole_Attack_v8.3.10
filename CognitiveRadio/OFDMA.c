...
int fn_NetSim_Init_OFDMA(BS_PHY* pstruBSPhy)
{
	...
	{
		double dDLTime = (10000-pstruBSPhy->dTTG)*pstruBSPhy->dDlUlRatio;
		double dULTime = (10000-pstruBSPhy->dTTG) - dDLTime;
		pstruSymbol->nDownLinkSymbol = (int)(dDLTime/pstruSymbol->dSymbolDuration);
		pstruSymbol->nUPlinkSymbol = (int)(dULTime/pstruSymbol->dSymbolDuration);
	}
