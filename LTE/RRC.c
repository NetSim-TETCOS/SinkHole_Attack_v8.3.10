...
{
	RRC_CONNECTION_REQUEST* request=((LTE_MAC_PACKET*)(pstruEventDetails->pPacket->pstruMacData->Packet_MACProtocol))->MessageVar;
...
int fn_NetSim_LTE_RRC_ProcessSetup()
{
	...
	RRC_CONNECTION_SETUP* setup=((LTE_MAC_PACKET*)pstruEventDetails->pPacket->pstruMacData->Packet_MACProtocol)->MessageVar;
	LTE_MAC_PACKET* macPacket;
	LTE_PHY_PACKET* phyPacket;
	NetSim_PACKET* packet;
	NETSIM_ID UEId=pstruEventDetails->nDeviceId;
