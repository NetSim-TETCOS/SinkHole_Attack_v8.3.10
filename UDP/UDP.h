...
int fn_NetSim_UDP_Create_ApplicationMetrics(NETSIM_ID, NETSIM_ID, NETSIM_ID, NETSIM_IPAddress, NETSIM_IPAddress, UDP_METRICS **);
...
_declspec(dllexport) int fn_NetSim_UDP_Metrics(char *);
int fn_NetSim_UDP_Metrics_F(char *);
