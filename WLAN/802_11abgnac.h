...
int fn_NetSim_WLAN_802_11ac_BER(NETSIM_ID nDeviceId,NETSIM_ID nInterfaceId,NetSim_PACKET *pstruPacket);
...
int fn_NetSim_WLAN_802_11b_BER(NETSIM_ID nDeviceId,NETSIM_ID nInterfaceId,NetSim_PACKET *pstruPacket);
int fn_NetSim_WLAN_802_11a_11g_BER(NETSIM_ID nDeviceId,NETSIM_ID nInterfaceId,NetSim_PACKET *pstruPacket);
